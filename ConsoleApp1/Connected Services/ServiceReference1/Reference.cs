...
namespace ServiceReference1
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://itcraftsman.pl/", ConfigurationName="ServiceReference1.WebService1Soap")]
    public interface WebService1Soap
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://itcraftsman.pl/MaxDiscount", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<decimal> MaxDiscountAsync(int amount, bool isOnSale, decimal price);
    }
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        public System.Threading.Tasks.Task<decimal> MaxDiscountAsync(int amount, bool isOnSale, decimal price)
        {
            return base.Channel.MaxDiscountAsync(amount, isOnSale, price);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.WebService1Soap))
            {
                return new System.ServiceModel.EndpointAddress("https://wsdlservice20190617081427.azurewebsites.net/WebService1.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.WebService1Soap12))
            {
                return new System.ServiceModel.EndpointAddress("https://wsdlservice20190617081427.azurewebsites.net/WebService1.asmx");
